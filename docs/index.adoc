...
NOTE: We also need couple other files: `Gemfile` (link:https://octodemo.com/OctoCheese/Calculator/blob/master/Gemfile[source]), `Rakefile` link:https://octodemo.com/OctoCheese/Calculator/blob/master/Rakefile[source]), and `_config.yml` link:https://octodemo.com/OctoCheese/Calculator/blob/master/_config.yml[source]).
